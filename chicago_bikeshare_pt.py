...
print("\nNúmero de linhas na base de dados:", len(data_list))

# Imprimindo a primeira linha de data_list para verificar se funcionou.
print("\nImprimindo a primeira linha de data_list (o cabeçalho dos dados) para verificar se funcionou:")
...
stdl = sorted([float(i) for i in trip_duration_list])
